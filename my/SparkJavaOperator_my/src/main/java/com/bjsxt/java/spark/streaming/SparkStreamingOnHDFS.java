...
public class SparkStreamingOnHDFS {
	public static void main(String[] args) {
		...
		final String checkpointDirectory = "hdfs://mycluster/library/SparkStreaming/CheckPoint_20170523";
	...
	private static JavaStreamingContext createContext(String checkpointDirectory,SparkConf conf) {
		 ...
		 */
		JavaDStream<String> lines = ssc.textFileStream("hdfs://mycluster/hdfs/");
